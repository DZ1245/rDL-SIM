...
python train_SR_Inference_Module.py --gpu_id '4' --gpu_memory_fraction 0.4 \
...
python train_rDL_Denoising_Module.py --gpu_id '4' --gpu_memory_fraction 0.4 \
